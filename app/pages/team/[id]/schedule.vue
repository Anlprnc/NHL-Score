  ...
  <div class="min-h-screen p-4 md:p-8">
    ...
    <div v-else-if="team" class="max-w-5xl mx-auto">
      ...
      >
        ...
        <div class="p-6 md:p-8 flex flex-col md:flex-row items-center gap-6">
          ...
          <div class="text-center md:text-left flex-1">
            <h1 class="font-orbitron text-3xl md:text-4xl font-black text-white mb-2">
              {{ team.displayName }}
            </h1>
      ...
      <div class="flex justify-center gap-2 mb-8">
        <button
          @click="activeTab = 'all'"
          class="px-5 py-2.5 rounded-xl font-orbitron font-bold text-sm transition-all duration-300"
          :class="activeTab === 'all' 
      ...
      <div class="space-y-3">
        <NuxtLink
          ...
          class="block group"
        >
          <div class="bg-gradient-to-br from-puck-light/80 to-puck/80 backdrop-blur-sm rounded-xl border border-ice-900/30 overflow-hidden transition-all duration-300 hover:border-ice-500/50 hover:scale-[1.01]">
            <div class="flex items-center p-4 gap-4">
              ...
              <div class="text-right min-w-[80px]">
                <div v-if="game.result" class="flex items-center justify-end gap-2">
                  <span 
                    class="px-2 py-1 rounded text-sm font-orbitron font-bold"
              ...
              <!-- Broadcasts -->
              <div v-if="game.broadcasts?.length && !game.status.completed" class="hidden md:block text-right min-w-[80px]">
